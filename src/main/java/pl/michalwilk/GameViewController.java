...
public class GameViewController {
    ...
    public void initialize(){
        ...
        high_score = gameSavedData.get_highest_score();
        highscore_label.setText("HIGHSCORE: " + high_score);
        current_score = 0;
    }
    ...
    public void shutdown(){
        ...
        gameSavedData.set_highest_score(high_score);
    ...
    private void update_score() {
        ...
        score_label.setText("SCORE: " + current_score);
        label_text = score_label.getText();
        game_grid.set_round_score(0);
    }

    public GameViewController(){
        GameSavedData gm = GameSavedData.load_from_memory();
        if (App.is_game_continued()){
            gameSavedData = gm;
        }
        else{
            gameSavedData = new GameSavedData();
            gameSavedData.set_highest_score(gm.get_highest_score());
        }
